...
const AccountCard = ({ account, onUpdateIsDefault}) => (
  <div className="relative">
    <div className="relative bg-gradient-to-br from-[#aeadad] via-[#1d1d1d] to-[#000000] h-[25vh] min-h-[200px] p-6 rounded-4xl shadow-2xl border border-orange-500/20 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:shadow-orange-500/20 hover:shadow-2xl hover:scale-[1.02] hover:border-orange-500/40">
